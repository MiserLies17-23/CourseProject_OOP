...
{
    public partial class VisitorSectionControl : UserControl
    {
        private readonly ExhibitController _controller;

        private readonly SectionEnum _section;

        public event Action<int>? ViewButtonEvent;

        public event Action? CloseButtonEvent;

        public VisitorSectionControl(ExhibitController controller, SectionEnum section)
        {
            InitializeComponent();
        ...
        private async void VisitorSectionControl_Load(object sender, EventArgs e)
        {
